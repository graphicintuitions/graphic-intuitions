    ...
    return (
      <HomeLayout>
        ...
        <Grid>
          {projects
            .map(({ node: project }) => (
              <Cell key={project.id} width={12} style={{
                position: "relative",
                marginBottom: "110px",
                minHeight: "490px"
              }}>
        ...
        <Grid style={{ marginBottom: "130px", padding: "80px 120px", background: "#fff", justifyItems: "center" }}>
        ...
        <Testimonials columns={12}>
          <Cell className={"testimonial"} width={6} left={4}>
            <div className={"logo"}>
              <div className={"logo__container"} width={12}><img src={testimonialLogo} alt={"testimonial logo"} /></div>
            </div>
            <Grid columns={6}>
              <Cell className={"quote"}>&ldquo;</Cell>
              <Cell width={4} left={2}>
              ...
              <Cell className={"quote"}>&rdquo;</Cell>
            </Grid>
          </Cell>
        </Testimonials>
      </HomeLayout>
